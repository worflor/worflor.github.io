 ...
 *
 * the predictor is seven axes of attention (6 temporal + 1 spatial), grounded
 * in the same
 * Boolean lattice / inclusion-exclusion math as the spatial Möbius codecs:
 *
 ...
 * ── implementation ────────────────────────────────────────────────────────────
 *
 * the entire codec is hand-written WebAssembly (logos.wat → logos.wasm, 6,905 bytes).
 * the WASM binary is inlined below as base64. zero dependencies.
 *
 * WASM memory layout (94 pages = 6.0 MB):
 ...
 *
 * 32 WASM globals hold scalar state at register speed. ~2.8MB predictor state + 3×1MB I/O buffers.
...
const WASM_B64 = '';
